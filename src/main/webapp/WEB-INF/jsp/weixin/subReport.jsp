...
<html>
  <head>
    ...
    <title>审核报告</title>
	<meta charset="utf-8">
	<meta http-equiv="description" content="审核报告">
  ...
  <body>
			...
			<center>
				<li>
					<div class="am-gallery-item "
						...
						<a href="${pageContext.request.contextPath}/News/listUI/pid/${dataPicture[0]}"><img
							id="img1" src="C:/ZHDJ/upload/file/${dataPicture[0]}"
							alt="" style="width: 100px;height: 63px;" /></a>
					</div>
				</li>
				<li>
					<div class="am-gallery-item" style="float: left;margin-left: 20px;">
						<a href="${pageContext.request.contextPath}/News/listUI/pid/${dataPicture[1]}"><img
							id="img2" src="${pageContext.request.contextPath}/News/listUI/pid/${dataPicture[1]}"
							alt="" style="width: 100px;height: 63px;" /></a>
					</div>
				</li>
				<li>
					<div class="am-gallery-item" style="float: left;margin-left: 20px;">
						<a href="${pageContext.request.contextPath}/News/listUI/pid/${dataPicture[2]}"><img
							id="img3" src="${pageContext.request.contextPath}/News/listUI/pid/${dataPicture[2]}"
							alt="" style="width: 100px;height: 63px;" /></a>
					</div>
				</li>
			</center>
	...
	<div class="am-g" style="">
		...
		<textarea class="" rows="5"  id="objection" placeholder="请填写批改意见"></textarea>
		</div>
	</div>

	<div class="am-g" style="margin-top: 18px;">
		<center>
			<button id="sub" type="button" class="am-btn am-btn-success" style="margin-right: 50px;">通过审核</button>
			<button id="Nosub" type="button" class="am-btn am-btn-danger" style="margin-left: 50px;">不通过</button></center>
	</div>
	...
	<script type="text/javascript">
		...
		$(function(){
            ...
            var id=$.getUrlParam('tastId');
            
            $('#sub').on('click',function(){
            	
            	$.ajax({
				url:'${pageContext.request.contextPath}/CheckFinish',
				dataType:'json',
				type:'post',
				data:{	tastId:id,
					    uuid:uuid,
					    finishOk:1,
					    finishContent:$('#objection').val()

...
<head>
	<title>民主生活会</title>
	<meta http-equiv="description" content="民主生活会">
...
<body>
	<div style="background-color: #0e90d2;height: 3em;">
                ...
                <center><span style="font-size: 20px;position:relative;bottom: 20px;color: #F4F4F4;font-weight: bold;">民主生活会</span></center>
    </div>
   ...
   <script>
	...
	<script type="text/javascript">
		...
		function createNode(nodeData){
			...
			var $newB1=$("<b style='font-size: 15px;'>时间:"+nodeData.time+"</b>");
			var $newB2=$("<b style='float: right;'>"+nodeData.cd+"</b>");
			...
			$.ajax({
				...
				success:function(data){
					...
					jump:function(context,first){
						if(!first){
							location.href="${pageContext.request.contextPath}/base/goURL/weixin/MetMinS?id="+treeId+"&page1="+context.option.curr;
						}
					}
					})
				}

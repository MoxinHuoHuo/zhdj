...
<html>
  <head>
    ...
    <meta charset="utf-8">
  	<meta http-equiv="description" content="个人任务下达">
  ...
  <form id="sentpro" class="am-form am-form-horizontal" method="post" data-options="novalidate:true" enctype="multipart/form-data" style="margin-top: 10px;">
	    ...
	    <div class="am-u-sm-5" style="padding-right: 0px;">
		  	<div style="margin-top: 10px;"><img src="${pageContext.request.contextPath}/images/po5.png" width="23" style="margin-left: 10px;margin-bottom: 8px;margin-right: 5px;"><b>选择成员:</b>
		  	</div>
		  </div>
	    <div id="selectpeo" class="am-u-sm-7" style="padding-left: 0px;margin-top: 5px;position: relative;right: 25px;">
	      <input type="text" name="" id="per" placeholder="请选择成员">
	  ...
	  <div class="am-form-group">
	    ...
	    <div class="am-u-sm-7" style="padding-left: 0px;margin-top: 5px;position: relative;right: 25px;">
	      <input value="" name="startTime" class="am-form-field datePicker" id='datetimepicker1' placeholder="请选择开始时间">
	    </div>
 	  </div>
 	  <div class="am-form-group">
	    <div class="am-u-sm-5" style="padding-right: 0px;">
	    ...
	    <div class="am-u-sm-7" style="padding-left: 0px;margin-top: 5px;position: relative;right: 25px;">
	      <input value="" name="finishTime" class="am-form-field datePicker2" id='datetimepicker2' placeholder="请选择结束时间">
	    </div>
 	  </div>
	...
	var userId=<%=session.getAttribute("RelUserLoginId")%>;
       ...
       if (/Android (\d+\.\d+)/.test(ua)){
		...
		$('#selectpeo').on('click',function(){
			location.href="${pageContext.request.contextPath}/base/goURL/weixin/SelectPeo?id=64&page1=1"
		})
		...
		$('#sentcofirm').on('click',function(){
			...
			var sentpro=new FormData($('#sentpro')[0]);
				...
				sentpro.append('ids',$('#id').val());
				sentpro.append('userId',userId);
				$.ajax({

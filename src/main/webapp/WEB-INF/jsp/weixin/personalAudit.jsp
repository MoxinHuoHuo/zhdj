  ...
  <form id="sendmeet" class="am-form am-form-horizontal" style="margin-top: 10px;" method="post" data-options="novalidate:true" enctype="multipart/form-data">
	   ...
	   <div class="am-form-group am-form-file">
	    <div class="am-u-sm-4" style="padding-right: 0px;">
		  	<div style="margin-top: 10px;"><img src="${pageContext.request.contextPath}/images/met.png" width="23" style="margin-left: 10px;margin-bottom: 8px;margin-right: 5px;"><b>选择人员:</b>
		  	</div>
		</div>
...
var ogAudit={
	...
	chooseOg:function(){			//跳转到选择组织页面
		...
		$.cookie("partClass",$("#partClass").val());
	  	location.href="${pageContext.request.contextPath}/base/goURL/weixin/statOgList?og=false";
	},

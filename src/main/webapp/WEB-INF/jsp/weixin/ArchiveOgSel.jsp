...
<body>
	...
	<div class="am-header-left am-header-nav" >
		<a href="${pageContext.request.contextPath}/base/goURL/weixin/mtArchive?hasCookie=true"><img class="am-header-icon-custom"
		...
		select:function(){									//选中组织跳转
			...
			if(!$("div").hasClass("select"))
				...
				if($(".ogTitle").hasClass("select"))
					...
					if(og){
						$.cookie("treeId",treeId);
						$.cookie("ogName",ogName);
						location.href=encodeURI("${pageContext.request.contextPath}/base/goURL/weixin/mtArchive?hasCookie=true");
					}else{
						location.href=encodeURI("${pageContext.request.contextPath}/base/goURL/weixin/statSelectPeople?treeId="+treeId);
					}
				}
			}
		},

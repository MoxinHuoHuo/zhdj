...
<head>
	<title>党员大会</title>
	<meta http-equiv="description" content="党员大会">
      			...
      			<div class="weui-panel__bd" id="body">
      				<%-- <div class="weui-media-box weui-media-box_appmsg">
	      				<div class="weui-media-box__hd">
				        	<img width="10" class="weui-media-box__thumb" src="${pageContext.request.contextPath}/images/met.png">
				      	</div>
				      	<div class="weui-media-box__bd">
					        ...
					        <p class="weui-media-box__desc" style="margin-bottom: 3px;margin-top: 12px;">
				            	...
				            	<b style="float: right;"><button class="weui-btn weui-btn_mini weui-btn_primary" style="">查看</button></b>
			            	</p>
				      	</div>
				      </div>
				      <div class="weui-media-box weui-media-box_appmsg">
   ...
   <script>
	...
	<script type="text/javascript">
		...
		function createNode(nodeData){
			...
			var $newBt=$("<button class='weui-btn weui-btn_mini weui-btn_primary bt' style='margin-top:8px;'>查看</button>");
		...
		function showT(){
			$.ajax({
				...
				dataType:'json',
				type:'post',
				data:{time1:time1,time2:time2,orgId:orgId,type:type},
				success:function(data){
					...
					jump:function(context,first){
						if(!first){
							location.href="${pageContext.request.contextPath}/base/goURL/weixin/MetDYuon?id="+treeId+"&page1="+context.option.curr;
						}
					}
					})
				}
		...
		$(document).on('click','.bt',function(){
			...
			location.href="${pageContext.request.contextPath}/base/goURL/weixin/attendSta?id="+id
		})
	</script>
</body>
</html>
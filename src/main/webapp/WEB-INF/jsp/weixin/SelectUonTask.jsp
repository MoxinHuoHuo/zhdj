...
<body>
	...
	<div class="am-g am-u-sm-centered" style="margin: 10px 0 0 5px;">
		...
		<a href="javascript:void(0)" onclick="organ.showU()" class="am-btn am-btn-primary am-radius" style="float:right">选择</a>
	</div>
	...
	<div class="am-modal am-modal-prompt" tabindex="-1" id="seeModal">
		<div class="am-modal-dialog">
			<div class="am-modal-hd">是否选择：</div>
			<div style="font-size:16px" class="am-modal-bd">
				<b id="name"></b>
			</div>
			<div class="am-modal-footer">
				<span class="am-modal-btn" data-am-modal-cancel>取消</span> <span
					class="am-modal-btn" data-am-modal-confirm onclick="organ.confirmSel()">确认</span>
			</div>
		</div>
	</div>
	...
	var organ={
		...
		showU:function(){
			$('#name').html($(".select").children().last().html());
			$('#hasId').val($(".select").children().eq(0).val());
			$('#seeModal').modal();
		},
		confirmSel:function(){
			var uName=$('#uName').val();
			var uid=$('#hasId').val();
			location.href="${pageContext.request.contextPath}/base/goURL/weixin/StaticTask?uon="+uid
		},

...
<head>
	<title>党课</title>
	<meta http-equiv="description" content="党课">
...
<body>
	<div style="background-color: #0e90d2;height: 3em;">
                ...
                <center><span style="font-size: 20px;position:relative;bottom: 20px;color: #F4F4F4;font-weight: bold;">党课</span></center>
    </div>
			...
			$.ajax({
				...
				success:function(data){
					...
					jump:function(context,first){
						if(!first){
							location.href="${pageContext.request.contextPath}/base/goURL/weixin/MetDke?id="+treeId+"&page1="+context.option.curr;
						}
					}
					})
				}

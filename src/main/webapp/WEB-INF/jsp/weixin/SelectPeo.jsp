...
<body ontouchstart>
	<header data-am-widget="header"
  	...
  	<div data-am-widget="titlebar" class="am-titlebar am-titlebar-default" >
	    ...
	    <nav class="am-titlebar-nav">
	        <button id="view" type="button" class="am-btn am-btn-success am-radius" style="margin-bottom:10px;">查看已选</button>
	        <button id="allsel" type="button" class="am-btn am-btn-warning am-radius" style="margin-bottom:10px;">全选</button>
	        <button id="clear" type="button" class="am-btn am-btn-danger am-radius" style="margin-bottom:10px;">清空</button>
   ...
   <div data-am-widget="tabs"
	...
	function confirm(){
		...
		var id=str1;	
		location.href="${pageContext.request.contextPath}/base/goURL/weixin/sendPerproject?selName="+selName+"&ids="+id
	}
	//清空选择
	...
	function createNode1(nodeData){
		...
		var $newButton=$("<button type='button' class='am-btn am-btn-primary am-radius selbtn' style='width:80px;height: 32px;'>选择</button>");
	...
	function confirmall(){
		var str=n;
		str=str.substring(0,str.length-1); //去掉后面的逗号
		$('#ids').val(str);
		var str1=i;
		str1=str1.substring(0,str1.length-1); //去掉后面的逗号
		$('#selName').val(str1);
		$('#havemodel').modal();
	}
		...
		success:function(data){
			...
			jump:function(context,first){
				...
				if(!first){
					...
					location.href="${pageContext.request.contextPath}/base/goURL/weixin/SelectPeo?id="+treeId+"&page1="+context.option.curr;
				}
			}
			})
			$(".selbtn").each(function(){

...
<body>
   ...
   <script>
	...
	<script type="text/javascript">
		...
		var taskWarnId=<%=request.getParameter("taskWarnId")%>;
	...
	function createNode1(nodeData){
			...
			var $newH=$("<h4 class='weui-media-box__title'>姓名："+nodeData.userName+"</h4>");
			var $newP=$("<p class='weui-media-box__desc' style='margin-bottom: 3px;margin-top: 12px;'></div>");
			var $newB=$("<b style='font-size: 15px;'>手机号码:"+nodeData.userPhone+"</b>");
		...
		$.ajax({
			...
			success:function(data){
				...
				jump:function(context,first){
					if(!first){
						location.href="${pageContext.request.contextPath}/base/goURL/weixin/seeWarning?&page1="+context.option.curr+"&taskId="+taskId+"&taskWarnId="+taskWarnId;
					}
				}
				})
